    ...
    <div class="col-md-6">
        <div class="card card-primary card-outline mb-4">
            <div class="card-header">
                <h3 class="card-title">Tambah Jenis Indikator</h3>
            </div>
            <form action="<?= base_url('jenis-indikator/store') ?>" method="post">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="jenis_indikator" name="jenis_indikator" value="<?= old('jenis_indikator') ?>" required>
                        </div>
                    </div>
