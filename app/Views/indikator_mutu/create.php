    ...
    <div class="col-md-12">
        <div class="card card-primary card-outline mb-4">
            <div class="card-header">
                <h3 class="card-title">Tambah Indikator Mutu</h3>
            </div>
            <form action="<?= base_url('indikator-mutu/store') ?>" method="post">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="judul_indikator" name="judul_indikator" value="<?= old('judul_indikator') ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="dimensi_mutu" name="dimensi_mutu" value="<?= old('dimensi_mutu') ?>" required>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-9">
                            <select class="form-select select2" id="jenis_indikator_id" name="jenis_indikator_id" required>
                                ...
                                <?php foreach ($jenis_indikator as $jenis) : ?>
                                    <option value="<?= $jenis['id'] ?>" <?= old('jenis_indikator_id') == $jenis['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" id="status_aktif" value="aktif" <?= old('status', 'aktif') == 'aktif' ? 'checked' : '' ?>>
                                <label class="form-check-label" for="status_aktif">
                                    Aktif
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="status" id="status_tidak_aktif" value="tidak aktif" <?= old('status') == 'tidak aktif' ? 'checked' : '' ?>>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="definisi_operasional" name="definisi_operasional" rows="3" required><?= old('definisi_operasional') ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="numerator" name="numerator" rows="2" required><?= old('numerator') ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="denumerator" name="denumerator" rows="2" required><?= old('denumerator') ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-3">
                            <select class="form-select" id="standar_target_pencapaian" name="standar_target_pencapaian" required>
                                ...
                                <option value=">" <?= old('standar_target_pencapaian') == '>' ? 'selected' : '' ?>>></option>
                                <option value="<" <?= old('standar_target_pencapaian') == '<' ? 'selected' : '' ?>><</option>
                                <option value=">=" <?= old('standar_target_pencapaian') == '>=' ? 'selected' : '' ?>>>=</option>
                                <option value="<=" <?= old('standar_target_pencapaian') == '<=' ? 'selected' : '' ?>><=</option>
                            </select>
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="target_pencapaian" name="target_pencapaian" value="<?= old('target_pencapaian') ?>" required>
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="kriteria_inklusi" name="kriteria_inklusi" rows="2"><?= old('kriteria_inklusi') ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="kriteria_eksklusi" name="kriteria_eksklusi" rows="2"><?= old('kriteria_eksklusi') ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="sumber_data" name="sumber_data" value="<?= old('sumber_data') ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="frekuensi_pengumpulan_data" name="frekuensi_pengumpulan_data" value="<?= old('frekuensi_pengumpulan_data') ?>">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="periode_analisis_data" name="periode_analisis_data" value="<?= old('periode_analisis_data') ?>">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="rencana_analisis" name="rencana_analisis" rows="3"><?= old('rencana_analisis') ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="instrumen_pengambilan_data" name="instrumen_pengambilan_data" value="<?= old('instrumen_pengambilan_data') ?>">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="area_pengukuran" name="area_pengukuran" value="<?= old('area_pengukuran') ?>">
                        </div>
                    </div>
                </div>
